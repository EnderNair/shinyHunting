...
#Date: 3/26/2023
#Automagic Wild Encounter Shiny Finder
...
# Displays message with total encounters and time
end_time = time.time()
...
#Telegram bot sends message to Channel
'''
bot = telegram.Bot(token='')

chat_id = '-'
text = 'Your Shiny Hunting Script has found a Shiny Pokemon!'
